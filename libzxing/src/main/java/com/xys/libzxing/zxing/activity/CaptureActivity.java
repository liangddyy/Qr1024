...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private Button btnAlipayQr;
    private Button btnWechatQr;
    ...
    public void onCreate(Bundle icicle) {
        ...
        btnAlipayQr = (Button) findViewById(R.id.btn_alipay_qr);
        btnWechatQr = (Button) findViewById(R.id.btn_wechat_qr);
        //btnAlipayPay = (Button) findViewById(R.id.btn_alipay_pay);

        btnAlipayQr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    ...
                    //若无法正常跳转，在此进行错误处理
                    Toast.makeText(CaptureActivity.this, "无法跳转到支付宝，请检查您是否安装了支付宝！", Toast.LENGTH_SHORT).show();
                }
            }
        });
